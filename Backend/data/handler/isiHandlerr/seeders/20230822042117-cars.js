...
/** buat sembarang data yg sifatnya sementara */
'use strict';
...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    for (let i = 0; i < arrData.length; i++) {
      ...
      const image_url = `https://res.cloudinary.com/dp9w7myzm/image/upload/v1692174027/bcr-management-dashboard/${image.split('/')[2]}`;
